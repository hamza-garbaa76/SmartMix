...
\subsection{Collaboration avec l'IA (Section Obligatoire)}
Nous avons utilisé l'IA (ChatGPT/Gemini) comme assistant technique :
\begin{itemize}
    \item \textbf{Aide API :} L'IA nous a aidés à comprendre la structure JSON d'iTunes.
    \item \textbf{Débogage :} Résolution de problèmes cURL et regex.
\end{itemize}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=13cm]{IMG_4847.jpeg}
    \caption{Liste des résultats générés}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=13cm]{IMG_4848.jpeg}
    \caption{Lecteur audio et téléchargement}
\end{figure}

\subsection{Annexe C : Structure CSV}
